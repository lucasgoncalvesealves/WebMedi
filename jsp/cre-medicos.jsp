...
<div id="wrapper">
	...
	<div id="subheader" class="credenciador">
	 	<div><img src="${pageContext.request.contextPath}/png/medico.png" /></div>
        <h1>Médicos</h1>
    ...
    <div id="content">
        ...
        <table>
    	  ...
    	  <tr>
        	<td>CRM do médico</td>
     	    <td><input type="text" name="crm" pattern="[0-9]+$" /></td>
       	 </tr>
    	  <tr>
        	<td style="vertical-align: text-top;">Endereço do médico</td>
