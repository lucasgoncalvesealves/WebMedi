...
<title>Cobrar Contingência</title>
</head>
<body>
<div id="wrapper">
	<div id="header">
	...
	<div id="subheader" class="administrador">
	 	<div><img src="${pageContext.request.contextPath}/png/contingencia.png" /></div>
        <h1>Contingências</h1>
        <a class="voltar" href="${pageContext.request.contextPath}/jsp/administrador.jsp">Voltar</a>        
    </div>
    <div id="content">
        <h2>Cobrar Contingência</h2>
        <form>
        <table>
  	      <tr>
