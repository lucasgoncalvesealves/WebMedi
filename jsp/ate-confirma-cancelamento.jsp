...
Date dataCancela = new Date();
SimpleDateFormat sdf1 = new SimpleDateFormat("HH:mm");
String horaCancela = sdf1.format(dataCancela);
SimpleDateFormat sdf2 = new SimpleDateFormat("dd/MM/yyyy");
String cDataCancela = sdf2.format(dataCancela);
session.setAttribute("dataCancela", dataCancela);
session.setAttribute("horaCancela", horaCancela);
%>
...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <form method="post" action="${pageContext.request.contextPath}/ConfirmarCancelamento.do">
        <table>
  	      <tr>
