...
public class ValidarDadosExecucaoServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("solicitaSel") != null) {
			...
			msgRet = agendaBean.validarDadosExecucao(numCartao,nomProced,codSolicita);
		}
		else {
			msgRet = "Nenhum Agendamento Selecionado.";
		}
		if (msgRet == "") {
			...
			RequestDispatcher view = request.getRequestDispatcher("jsp/ate-confirma-execucao.jsp");
